...
Shape unit tests after the corpus's testing rules. A rule's `<slug>.bad.al` sample is
a ready-made "should fail" scenario — turn it into a negative test. Cite the rule a
